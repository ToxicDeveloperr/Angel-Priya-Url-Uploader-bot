...
async def help_user(bot, update):
    if update.from_user.id in Config.AUTH_USERS:
        ...
        await bot.send_message(
            ...
            reply_to_message_id=update.id     # yahan update.message_id ki jagah update.id
        )
...
async def start(bot, update):
    if update.from_user.id in (Config.AUTH_USERS & Config.LAZY_DEVELOPER):
        ...
        await bot.send_message(
            ...
            reply_to_message_id=update.id   # yahan bhi
        )
        ...
        await bot.send_message(
            ...
            reply_to_message_id=update.id  # aur yahan bhi
        )
    else:
        # logger.info(update) ==         
        await bot.send_message(
